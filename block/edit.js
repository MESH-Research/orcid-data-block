		...
		<div { ...blockProps }>
			...
			<SelectControl
				...
				options={ [
					...
					{
						label: 'DISSERTATION_THESIS',
						value: 'dissertation-thesis',
					},
					{ label: 'EDITED_BOOK', value: 'edited-book' },
					{
						label: 'ENCYCLOPEDIA_ENTRY',
						value: 'encyclopedia-entry',
					},
					...
					{
						label: 'NEWSLETTER_ARTICLE',
						value: 'newsletter-article',
					},
					...
					{
						label: 'REGISTERED_COPYRIGHT',
						value: 'registered-copyright',
					},
					{ label: 'REVIEW', value: 'review' },
					{ label: 'REPORT', value: 'report' },
					{
						label: 'RESEARCH_TECHNIQUE',
						value: 'research-technique',
					},
					{ label: 'RESEARCH_TOOL', value: 'research-tool' },
					{ label: 'SOFTWARE', value: 'software' },
					{ label: 'SPIN_OFF_COMPANY', value: 'spin-off-company' },
					{
						label: 'STANDARDS_AND_POLICY',
						value: 'standards-and-policy',
					},
					{
						label: 'SUPERVISED_STUDENT_PUBLICATION',
						value: 'supervised-student-publication',
					},
					{
						label: 'TECHNICAL_STANDARD',
